...
class Test_TopRatedMovie():
    ...
    def test_topratedmovie(self):
        ...
        top_rated_movie_responce = requests.get(self.url)

        status_code = top_rated_movie_responce.status_code
        assert status_code == 200

        top_rated_movie_json = top_rated_movie_responce.json()
